...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/stonkscoin-project/stonkscoin>";
    const std::string URL_WEBSITE = "<https://stonkscoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Stonkscoin version %s\n", FormatFullVersion());
}
