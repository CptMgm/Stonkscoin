...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s stonkscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  stonkscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stonkscoin transaction") + "\n" +
              "  stonkscoin-tx [options] -create [commands]   " + _("Create hex-encoded stonkscoin transaction") + "\n" +
              "\n";
