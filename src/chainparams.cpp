...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.stonkscoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.stonkscointools.com", true);
        vSeeds.emplace_back("dnsseed.stonkscoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.stonkscointools.com", true);
        vSeeds.emplace_back("seed-b.stonkscoin.loshan.co.uk", true);
